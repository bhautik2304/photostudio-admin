      ...
      <Page size="A4" style={styles.page}>
        <View style={[styles.gridContainer, styles.mb40]}>
          ...
          <View style={{ alignItems: 'flex-end', flexDirection: 'column' }}>
            <Text style={styles.h3}>{order_status}</Text>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>{costomer.name}</Text>
            <Text style={styles.body1}>{costomer.address}</Text>
            <Text style={styles.body1}>{costomer.phone}</Text>
          </View>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body1}>{fDate(order_date)}</Text>
          </View>
          {/* <View style={styles.col6}>
